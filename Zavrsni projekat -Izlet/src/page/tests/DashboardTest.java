...
public class DashboardTest {
	...
	public static void fillPostScanner(WebDriver driver) throws Exception {
		...
		case 3:
			...
			break;
		case 4:
			Dashboard.selectTransport(driver, "Bycicle");
			break;
		case 5:
	...
	public static void editPost(WebDriver driver) throws Exception {
		...
		int broj;
			...
			System.out.println("0. Odustanite od promene.");
			broj = sc.nextInt();
			switch (broj) {
			case 1:
